...
export class News extends Component {
  ...
  async updateNews(){
    const url= `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=e8fc83305d2c4605ac69e1575c4e8eec&page=1&pageSize=${this.props.pageSize}`;
  ...
  render() {
    return (
      ...
      <div className="container my-3">
        <h1 className="text-center" style={{margin: '30px 0px'}}> NewsHunter - Top Headlines </h1>
